import { controllerGetProducts, deleteAll, createProductsTable, controllerPostProducts, controllerGetProductsById, controllerPutProductbyId, controllerDeleteProductByID } from '../controllers/productController.js';
