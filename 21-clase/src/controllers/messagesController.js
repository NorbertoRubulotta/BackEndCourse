...
import { createTable } from '../persistence/tables/messagesTables.js';
...
export async function controllerPostMessages({ body }, res) {
    logger.info({ Route: req.originalUrl, Method: req.method, Message: 'New request' })
    try {
        const object = body;
...
export async function controllerGetByIdMessages({ params }, res) {
    logger.info({ Route: req.originalUrl, Method: req.method, Message: 'New request' })
    try {
...
export async function controllerPutByIdMessages({ body, params }, res) {
    logger.info({ Route: req.originalUrl, Method: req.method, Message: 'New request' })
    try {
...
export async function controllerDeleteById({ params }, res) {
    logger.info({ Route: req.originalUrl, Method: req.method, Message: 'New request' })
    try {
